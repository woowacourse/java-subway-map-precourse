...
- [x] 처음 역, 노선을 세팅
  - [x] 교대역, 강남역, 역삼역, 남부터미널역, 양재역, 양재시민의숲역, 매봉역 등록
  - [x] 노선은 2호선, 3호선, 신분당선 등록
    - [x] 2호선: 상행(교대역), 하행(역삼역) 등록
    - [x] 3호선: 상행(교대역), 하행(매봉역) 등록
    - [x] 신분당선: 상행(강남역), 하행(양재시민의숲역) 등록
  - [x] 구간 등록
    - [x] 2호선: 강남역
    - [x] 3호선: 남부터미널역, 양재역
    - [x] 신분당선: 양재역
- [x] 누른 숫자에 맞는 기능 화면으로 이동
- [x] 프로그램 종료
 
- [x] 예외 상황
  - [x] 각 상황에 맞지않는 다른 문자가 입력된 경우 재입력
    - [x] 1, 2, 3, 4, Q가 아닌 문자가 입력된 경우

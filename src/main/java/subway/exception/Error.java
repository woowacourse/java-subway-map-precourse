...
public enum Error {
    ...
    INVALID_STATION_NAME_LENGTH("역 이름은 " + Error.MINIMUM_STATION_NAME_LENGTH + "글자 이상입니다."), 
    INVALID_LINE_NAME_LENGTH("노선 이름은 " + Error.MINIMUM_LINE_NAME_LENGTH + "글자 이상입니다."),
    ...
    INVALID_NUMBER_OF_STATION_IN_LINE(
            "노선에는 최소 " + Error.MINIMUM_STATION_NUMBER_IN_LINE + "개의 역이 필요합니다.");

    private static final String ERROR_FORMAT = "[ERROR] %s\n\n";
    public static final int MINIMUM_STATION_NAME_LENGTH = 2;
    public static final int MINIMUM_LINE_NAME_LENGTH = 2;
    public static final int MINIMUM_STATION_NUMBER_IN_LINE = 2;

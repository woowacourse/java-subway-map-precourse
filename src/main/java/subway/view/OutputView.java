...
public interface OutputView {
    ...
    String ORDER_TO_ENTER_LINE = "## 노선을 입력하세요.";
    String ORDER_TO_ENTER_STATION = "## 역이름을 입력하세요.";
    String ORDER_TO_ENTER_SEQUENCE = "## 순서를 입력하세요.";
    String ORDER_TO_ENTER_LINE_TO_DELETE = "## 삭제할 구간의 노선을 입력하세요.";
    String ORDER_TO_ENTER_STATION_TO_DELETE = "## 삭제할 구간의 역을 입력하세요.";
    ...
    String SUCCESS_TO_REGISTER_SECTION_MESSAGE = "[INFO] 구간이 등록되었습니다.\n";
    String SUCCESS_TO_DELETE_SECTION_MESSAGE = "[INFO] 구간이 삭제되었습니다.\n";

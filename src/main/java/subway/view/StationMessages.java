...
public enum StationMessages {
	...
	OPTION_ERROR_MESSAGE(General.ERROR.getMessage() + "타당한 범위 내의 기능만 입력해주세요."),

	REGISTER_MESSAGE(General.BASIC.getMessage() + "등록할 역 이름을 입력하세요."),
	DUPLICATE_NAME_ERROR_MESSAGE(General.ERROR.getMessage() + "이미 등록된 역 이름입니다"),
	...
	DELETE_ERROR_MESSAGE(General.ERROR.getMessage() + "등록되지 않은 역입니다."),
	DELETE_COMPLETE_MESSAGE(General.INFO.getMessage() + "지하철 역이 삭제되었습니다."),

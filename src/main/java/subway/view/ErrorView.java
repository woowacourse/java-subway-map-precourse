...
public class ErrorView extends View {
    public static final String NOT_SELECTABLE_FEATURE = ERROR + "선택할 수 없는 기능입니다.";
    ...
    public static final String ALREADY_EXIST_SECTION = ERROR + "이미 존재하는 구간입니다. 갈래길을 만듦으로 해당 구간을 생성할 수 없습니다.";

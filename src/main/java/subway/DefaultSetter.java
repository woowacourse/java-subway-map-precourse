...
public class DefaultSetter {
    ...
    private static final List<String> LINE_NAME_LIST = Collections.unmodifiableList(
            Arrays.asList("2호선", "3호선", "신분당선"));
    private static final Map<String, List<String>> TO_ADD_SECTION_MAP = Collections.unmodifiableMap(
            new LinkedHashMap<>() {
                {
    ...
    private static final Map<String, List<String>> TO_INSERT_SECTION_MAP = Collections.unmodifiableMap(
            new LinkedHashMap<>() {
                {

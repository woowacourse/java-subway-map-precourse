...
public class StationManagementErrorPrinter {
    private static final String NEW_STATION_NAME_LENGTH_LESS_THAN_MIN_LENGTH_ERROR_MESSAGE
    ...
    public static void printNewStationNameLengthThanMinLengthErrorMessage() {
        System.out.println(NEW_STATION_NAME_LENGTH_LESS_THAN_MIN_LENGTH_ERROR_MESSAGE);
    }

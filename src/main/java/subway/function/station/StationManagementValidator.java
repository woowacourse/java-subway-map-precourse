...
public class StationManagementValidator {
    ...
    public static void validateIsStationNameLengthMinLengthOrMore(String stationName) throws IllegalArgumentException {
    ...
    public static void validateStationNameToRegister(String newStationName) throws IllegalArgumentException {
        validateIsStationNameLengthMinLengthOrMore(newStationName);
        CommonValidator.validateIsNotStationNameExists(newStationName);
    }

    public static void validateRegisteredInLineStationName(String stationName) throws IllegalArgumentException {
    ...
    public static void validateStationNameToDelete(String stationName) throws IllegalArgumentException {

...
public class SectionManagementErrorPrinter {
    private static final String STATION_ALREADY_EXISTS_IN_LINE_ERROR_MESSAGE
        = "\n" + Prefix.ERROR_PREFIX + "입력한 노선에 입력한 역이 이미 존재합니다.";
    ...
    private static final String NO_MORE_THAN_MIN_STATIONS_EXISTS_IN_LINE_ERROR_MESSAGE
        = "\n" + Prefix.ERROR_PREFIX + "입력한 노선에 포함된 역이 두개 이하이기 때문에, 구간 삭제를 할 수 없습니다.";
    private static final String NOT_EXISTS_STATION_IN_LINE_ERROR_MESSAGE
        = "\n" + Prefix.ERROR_PREFIX + "입력한 역은 입력한 노선에 존재하지 않습니다.";
    ...
    public static void printNoMoreThanMinStationsExistsInLineErrorMessage() {
        System.out.println(NO_MORE_THAN_MIN_STATIONS_EXISTS_IN_LINE_ERROR_MESSAGE);
    }

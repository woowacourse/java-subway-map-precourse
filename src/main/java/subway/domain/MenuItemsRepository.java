...
public class MenuItemsRepository {
    ...
    private static final List<String> mainSelections = Arrays.asList("1", "2", "3", "4", "Q");
    ...
    private static final List<String> stationSelections = Arrays.asList("1", "2", "3", "B");
    ...
    private static final List<String> sectionVSelections = Arrays.asList("1", "2", "B");
    ...
    public static List<String> getStationSelections() {
        return stationSelections;
    }

    public static List<String> getLineSelections() {
        return lineSelections;
    }

    public static List<String> getSectionSelections() {
        return sectionVSelections;
    }
}

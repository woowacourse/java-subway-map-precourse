...
- [ ] 노선을 노선 저장소에 추가하는 기능
- [ ] 추가하려는 노선 이름이 2자 이상인지 검증하는 기능
- [ ] 추가하려는 노선 이름이 노선 저장소 내의 노선과 중복되는지 검증하는 기능
- [ ] 노선 추가 시, 상행 종점역과 하행 종점역이 실제로 존재하는지 검증하는 기능
- [ ] 노선 추가 시, 상행 종점역과 하행 종점역이 서로 다른지 검증하는 기능
...
- [ ] 노선에 추가하려는 역이 노선에 이미 존재하는지 검증하는 기능
- [ ] 노선에 역을 제거하는 기능
- [ ] 노선에서 역을 제거 시, 노선에 남은 역의 수가 2개 초과인지 검증하는 기능

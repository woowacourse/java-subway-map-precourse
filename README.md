...
- [X] 역을 역 저장소에 추가하는 기능
- [X] 추가하려는 역 이름이 2자 이상인지 검증하는 기능
- [X] 추가하려는 역 이름이 역 저장소 내의 역과 중복되는지 검증하는 기능
- [X] 역을 역 저장소에서 제거하는 기능
- [X] 제거하려는 역이 노선에 포함되어 있는지 검증하는 기능

### 노선 및 노선 저장소 관련

- [X] 노선을 노선 저장소에 추가하는 기능
- [X] 추가하려는 노선 이름이 2자 이상인지 검증하는 기능
- [X] 추가하려는 노선 이름이 노선 저장소 내의 노선과 중복되는지 검증하는 기능
- [X] 노선 추가 시, 초기 역들이 2개 이상인지 검증하는 기능
- [X] 노선 추가 시, 초기 역들에 중복이 없는지 검증하는 기능
- [X] 노선을 노선 저장소에서 제거하는 기능

### 노선 구간 관련

- [X] 노선에 역을 추가하는 기능
- [X] 노선에 추가하려는 역이 실제로 존재하는지 검증하는 기능
- [X] 노선에 추가하려는 역이 노선에 이미 존재하는지 검증하는 기능
- [X] 노선에 역을 제거하는 기능
- [X] 노선에서 역을 제거 시, 노선에 남은 역의 수가 2개 초과인지 검증하는 기능
- [X] 노선에서 역을 모두 제거하는 기능

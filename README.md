...
* 메뉴에 따른 적절한 관리 화면을 나타낸다.  
* 관리 화면의 경우, 노선 관리와 역 관리를 Controller를 이용해 매핑한다.  
* 사용자는 역을 등록할 수 있다.  
    - (예외) 중복된 이름은 등록될 수 없다.  
    - (예외) 역의 이름은 2글자 이상이다.  
* 사용자는 역을 삭제할 수 있다.  
...
* 사용자는 지하철 노선의 목록을 조회할 수 있다.    
* 사용자는 지하철 노선을 삭제할 수 있다.  
    - (예외) 삭제 시 노선에는 두 개 이상의 역이 남아있어야 한다.  
* 사용자는 역을 노선에 추가할 수 있다.  

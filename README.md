...
- 정상적인 출력 결과는 [INFO] 를 써서 출력
- 예외 사항의 경우 [ERROR] 를 써서 출력
...
- 역의 목록을 조회 기능
#### 예외 처리
- 역을 삭제할 때 노선에 등록됐을 경우 (삭제 불가)
- 지하철 역 이름이 2글자 이상이 아닐 경우
- 지하철 역이 하나도 없을 때 목록을 표시했을 경우
- 지하철 역을 삭제할 때 어떤 노선에 남았을 경우 삭제 불가

### 노선
- 구간은 역과 역사이의 저장 순서에 의존한다
- 순서는 상행선부터 하행선까지의 정렬 순서로 간주한다
#### 기능
- 노선을 등록하는 기능
- 노선을 삭제하는 기능
- 구간을 등록하는 기능
- 구간을 삭제하는 기능
#### 예외 처리
- 노선의 남아있는 역이 2개인 경우 (삭제 불가)
- 노선의 이름이 같을 경우
- 노선의 상행선과 하행선이 같은 경우
- 노선의 상행선과 하행선이 없는 역일 경우
- 구간의 순서를 넘거나 적게 입력할 경우

...
### 0. 초기 설정 `InitializingController`
...
- [x] 등록할 역 입력
    - [x] 예외) 이미 존재하는 이름일 경우 예외 처리
- [x] 정상 등록 시, `[INFO] 지하철 역이 등록되었습니다.` 출력
- [x] 메인 화면으로 복귀

### 1.2 역 삭제

- [x] 삭제할 역 입력
- [x] 정상 삭제 시, `[INFO] 지하철 역이 삭제되었습니다.` 출력
- [x] 메인 화면으로 복귀
...
- [ ] 노선 관리 화면 출력
- [ ] 노선 관리 옵션 선택 `LineManagementOption`

### 2.1 노선 등록

- [ ] 등록할 노선 이름 입력
- [ ] 등록할 노선의 상행 종점역 이름을 입력
- [ ] 등록할 노선의 하행 종점역 이름을 입력
- [ ] 정상 등록 시, `[INFO] 지하철 노선이 등록되었습니다.` 출력
- [ ] 메인 화면으로 복귀

### 2.2 노선 삭제

- [ ] 삭제할 노선 이름 입력
- [ ] 정상 삭제 시, `[INFO] 지하철 노선이 삭제되었습니다.` 출력
- [ ] 메인 화면으로 복귀
...
- [ ] 구간 관리 화면 출력
- [ ] 구간 관리 옵션 선택 `SectionManagementOption`
